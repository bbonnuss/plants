...
class Image_():
    def __init__(self):
        ...
        self.shop_bg = pygame.image.load(join('assets','image','New_shop_bg.png')).convert()#New_shop_bg
...
class Player_farm():
    ...
    def draw_bg(self):
        ...
        #ปุ่ม total(จำนวน)
        pygame.draw.rect(window,(255,255,255),[590,140,50,50],3)
        #ปุ่ม price(ราคา)
        pygame.draw.rect(window,(255,255,255),[680,140,50,50],3)
        #ปุ่ม กากบาท(X)
        pygame.draw.rect(window,(255,255,255),[638,190,40,40],3)
        #ปุ่ม buy
        pygame.draw.rect(window,(255,255,255),[648,265,80,80],3)
        #ปุ่ม Home
        pygame.draw.rect(window,(255,255,255),[653,355,70,70],3) 
        # ปุ่มรดน้ำ
...
class Shop_menu():
    ...
    def run(self):
        ...
        window.blit(Image_().shop_bg,(0,1)) 
