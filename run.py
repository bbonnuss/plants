...
class Image_():
    def __init__(self):
        ...
        self.tomato_state1_wet = pygame.image.load(join('assets','image','tomato1_wet.png')).convert()
        ...
        self.potato_state1_wet = pygame.image.load(join('assets','image','potato1_wet.png')).convert()
        ...
        self.redcabbage_state1_wet = pygame.image.load(join('assets','image','redcabbage1_wet.png')).convert()
        ...
        self.orange_state1_wet = pygame.image.load(join('assets','image','orange1_wet.png')).convert()
        ...
        self.mango_state1_wet = pygame.image.load(join('assets','image','mango1_wet.png')).convert()
        ...
        self.apple_state1_wet = pygame.image.load(join('assets','image','apple1_wet.png')).convert()
        ...
        self.melon_state1_wet = pygame.image.load(join('assets','image','melon1_wet.png')).convert()
        ...
        self.grape_state1_wet = pygame.image.load(join('assets','image','grape1_wet.png')).convert()
        ...
        self.wheat_state1_dry = pygame.image.load(join('assets','image','wheat1_wet.png')).convert()
        ...
        self.cucumber_state1_dry = pygame.image.load(join('assets','image','cucumber1_dry.png')).convert()
        ...
        self.tomato_state1_dry = pygame.image.load(join('assets','image','tomato1_dry.png')).convert()
        ...
        self.potato_state1_dry = pygame.image.load(join('assets','image','potato1_dry.png')).convert()
        ...
        self.redcabbage_state1_dry = pygame.image.load(join('assets','image','redcabbage1_dry.png')).convert()
        ...
        self.orange_state1_dry = pygame.image.load(join('assets','image','orange1_dry.png')).convert()
        ...
        self.mango_state1_dry = pygame.image.load(join('assets','image','mango1_dry.png')).convert()
        ...
        self.apple_state1_dry = pygame.image.load(join('assets','image','apple1_dry.png')).convert()
        ...
        self.melon_state1_dry = pygame.image.load(join('assets','image','melon1_dry.png')).convert()
        ...
        self.grape_state1_dry = pygame.image.load(join('assets','image','grape1_dry.png')).convert()
